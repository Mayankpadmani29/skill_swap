...
const SignUp = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await axios.post(`${import.meta.env.VITE_BASE_URL}/api/auth/register`, { email, password, name })
        .then((res) => {
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <Button
                  ...
                  onClick={() => {
                    ...
                    // in production: https://your-backend.com/api/auth/google
                  }}
                >
                ...
                <Button
                  variant="outline"
                  onClick={() => window.location.href = `${import.meta.env.VITE_BASE_URL}/api/auth/github`}
                >
                  <svg
